...
eq(req.body.max_tokens, 4096, 'max_tokens is named (v0.35): unset, Groq budgets the model\'s own maximum output against a per-minute output budget and refuses before running');
